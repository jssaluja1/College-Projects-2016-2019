...
{
      var contnt = document.querySelector("#photo");

      var pic = "";
      for(var strt=0;strt<images.length;strt++)
      {
          pic += "<img alt='" + images[strt].alt + "'" + " src='" + images[strt].url + "' />" + "<figcaption>" + images[strt].caption + "</figcaption>" ;
      }
